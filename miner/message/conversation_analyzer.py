...
class ConversationAnalyzer:
    ...
    def get_stats(self, names: str = None, subject: str = 'all', start: Union[str, datetime] = None,
                  end: Union[str, datetime] = None, period: Union[str, datetime] = None) -> ConversationStats:
