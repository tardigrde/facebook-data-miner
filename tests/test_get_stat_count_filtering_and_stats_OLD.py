...
class TestGetCount:
    ...
    def test_total_number_of_characters(self, stat_count):
        ...
        assert stat_count(attribute="cc", start=dt(y=2014, m=9), period="m") == 23
        assert stat_count(attribute="cc", start=dt(y=2014, m=11), period="m") == 71
    ...
    def test_total_number_of_characters_sent(self, stat_count):
        ...
        assert (
            stat_count(attribute="cc", senders="me", start=dt(y=2014), period="y") == 68
        )
        assert (
